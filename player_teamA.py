...
class Player(Participant):
    ...
    ##############################################################################
            ...
            speeds_d1 = self.D1.move(self.d1_index, 
                                        self.idx, self.idx_opp, 
                                        self.defense_angle, self.attack_angle,
                                        self.cur_posture, self.cur_posture_opp,
                                        self.previous_posture, self.previous_posture_opp,
                                        self.previous_ball, self.cur_ball, self.predicted_ball,
                                        received_frame.game_state)
            speeds_d2 = self.D2.move(self.d2_index, 
                                        self.idx, self.idx_opp, 
                                        self.defense_angle, self.attack_angle,
                                        self.cur_posture, self.cur_posture_opp,
                                        self.previous_posture, self.previous_posture_opp,
            ...
            # if received_frame.game_state == Game.STATE_KICKOFF:
            #     speeds_f2 = [1, 1, 5, 0, 0, 0]

            self.speeds = speeds_gk + speeds_d1 + speeds_d2 + speeds_f1 + speeds_f2
